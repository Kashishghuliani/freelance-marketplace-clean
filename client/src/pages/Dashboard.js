      ...
      <main className="max-w-7xl mx-auto p-6 space-y-16">
        ...
        {user.role === "freelancer" && (
          <section>
            ...
            {gigs.length > 0 ? (
              <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
                {gigs.map((gig) => (
                  <div
                    key={gig._id}
                    className="bg-white rounded-xl shadow-lg hover:shadow-2xl transition overflow-hidden flex flex-col border border-blue-100"
                  >
                    {gig.images?.length > 0 ? (
                      <img
                        src={gig.images[0]}
                      ...
                      <div className="w-full h-44 bg-blue-50 flex items-center justify-center text-blue-300">
                        No Image
                      </div>
                    )}
                    ...
                    <div className="p-5 flex flex-col flex-grow">
                      ...
                      <p className="text-blue-700 text-sm mt-2">
                        ${gig.price} • {gig.deliveryTime} day(s)
                      </p>
                      ...
                      <div className="mt-5 border-t pt-4">
                        <h4 className="font-semibold text-blue-800 mb-3 text-sm uppercase">
                          Client Reviews:
                        </h4>
              ...
              <p className="text-blue-500 text-sm">
                You haven't created any gigs yet. Start by creating your first
                gig!
              </p>
            )}
            ...
            <Link
              to="/create-gig"
              className="fixed bottom-8 right-8 bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-700 hover:to-blue-600 text-white p-5 rounded-full shadow-xl sm:hidden transition hover:scale-105"
              title="Create Gig"
            >
              <FaPlus size={22} />
            </Link>
          ...
          {orders.length > 0 ? (
            <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
              {orders.map((order) => (
                <div
                  key={order._id}
                  className="bg-white rounded-xl shadow-lg hover:shadow-2xl transition p-6 border border-blue-100"
                >
